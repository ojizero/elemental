defmodule Elemental.Storybook.Components.Navigation.Dock do
  use PhoenixStorybook.Story, :component

  def function, do: &Elemental.Navigation.Dock.dock/1
  ...
  def imports do
    [
      {Elemental.Navigation.Dock, dock_action: 1},
  ...
  def variations do
    [
      %Variation{
        ...
        slots: [
          """
          <.dock_action :let={id} selected>
            <:label>Home</:label>
            <.button id={id} elemental-disable-styles>
